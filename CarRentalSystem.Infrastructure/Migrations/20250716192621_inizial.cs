    ...
    public partial class inizial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarApprovalStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarApprovalStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_CarApprovalStatuses_CarApprovalStatusId",
                        column: x => x.CarApprovalStatusId,
                        principalTable: "CarApprovalStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KYCUploads", x => x.KYCId);
                    table.ForeignKey(
                        name: "FK_KYCUploads_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarDocuments", x => x.DocumentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_CarApprovalStatusId",
                table: "Cars",
                column: "CarApprovalStatusId");
